		...
		search_button.onclick = function()
		{
			...
			$.ajax({
			   ...
			   success: function(data){
					...
					var tags_string = "";
					Array.from(tags).forEach(el => {tags_string += "<span class='tag'>" + el.getElementsByClassName("name")[0].textContent + "</span> ";});
					dj_tags.innerHTML = tags_string;
					dj_link.innerText = "Open in new tab";
...
/*
var tags = doc.querySelectorAll('.tag-container:not(.hidden)')[0].getElementsByTagName("a");
